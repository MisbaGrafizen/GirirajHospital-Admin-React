      ...
      items: [
        {
          ...
          href: "/dashboards",
          submenu: [
            { id: "Super Admin", label: "Default", href: "/dashboards/super-dashboard" },
            { id: "ecommerce", label: "Ecommerce", href: "/dashboards/ecommerce" },
            { id: "online-course", label: "Online Course", href: "/dashboards/online-course" },
            { id: "crypto", label: "Crypto", href: "/dashboards/crypto" },
            { id: "social", label: "Social", href: "/dashboards/social" },
            { id: "nft", label: "NFT", href: "/dashboards/nft" },
            { id: "school-management", label: "School Management", href: "/dashboards/school-management" },
            { id: "pos", label: "POS", href: "/dashboards/pos" },
