  ...
  return Math.round((vals.reduce((a, b) => a + b, 0) / vals.length) * 10) / 10;
    ...
    // Component
    // ------------------------------------------------------------------
    export default function EmployeeFeedbackDashBoard() {
        ...
        useEffect(() => {
            const fetchFrequentRatings = async () => {
                try {
                    const res = await ApiGet("/admin/frequent-employee-keywords"); // backend endpoint we made
        ...
        // ✅ Replace your current serviceIcons & SERVICE_GROUPS with:
const serviceIcons = {
  "Job Satisfaction": Star,
  "Feeling Valued": HeartPulse,
  "Growth Opportunities": Award,
  "Training Support": Stethoscope,
  "Welfare Facility": Building2,
  "Training Needed": Wrench,
  "Challenges / Support Needed": ShieldCheck,
  "Suggestions": MessageSquare,
};

const SERVICE_GROUPS = {
  "Job Satisfaction": ["jobSatisfaction"],
  "Feeling Valued": ["feelingValued"],
  "Growth Opportunities": ["growthOpportunities"],
  "Training Support": ["trainingSupport"],
  "Welfare Facility": ["welfareFacility"],
  "Training Needed": ["trainingNeeded"],
  "Challenges / Support Needed": ["challengesSupportNeeded"],
  ...
  return rows;
    ...
    const fetchEmployeeFeedback = useCallback(async () => {
  setLoading(true);
  setError(null);
  ...
  try {
    ...
    const list = data.map((d) => {
      ...
      return {
        ...
        floor: d.floor || "-",
        trainingNeeded: d.trainingNeeded || "-",
        challengesSupportNeeded: d.challengesSupportNeeded || "-",
        suggestions: d.suggestions || "-",
        rating: avgRating,
        overallRecommendation: d.overallRecommendation || 0,
      };
    });
    ...
    console.error("Fetch Employee Feedback failed:", e);
    ...
    fetchEmployeeFeedback();
        ...
        const exportToExcel = async () => {
            ...
            const feedbackHeaders = feedbackRows.length
                ...
                : ["Date", "Employee Name", "EmployeeId", "Doctor Name", "Average Rating (/5)"]
