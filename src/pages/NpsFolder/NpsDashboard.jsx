...
/>
                ...
                <div className="">
                  <main className="">
                    ...
                    <div className=" flex gap-[15px] ">
                      ...
                      <div className="grid grid-cols-1 w-[300px] md34:!gap-x-[15px]  mb-[-4px] mt -[-4px]  ">
                        <Widgets1
                          data={{
                            title: "Detractors",
                      ...
                      <div className=" flex gap-x-[15px]  mb-3">
                        <div className="bg-white rounded-xl dashShadow  min-w-[400px] 2xl:!w-[550px]  p-[13px]">
    ...
    <AreaChart data={areaData} key={areaKey} margin={{ left: -25, right: 8, top: 8, bottom: 0 }}>
      ...
      />
                        ...
                        <div className="bg-white rounded-xl dashShadow   w-[500px] p-[13px]">
                          <div className=" flex mb-[10px] items-center gap-[10px]">
                            <div className="w-[35px] h-[35px]  bg-gradient-to-br from-blue-500 to-indigo-500 rounded-md flex items-center justify-center">
