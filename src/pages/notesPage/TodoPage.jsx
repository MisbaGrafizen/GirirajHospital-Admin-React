          ...
          <div className="flex w-full h-full">
            ...
            <div className="flex flex-col bg-white w-full relative max-h-[93%] pb-[10px] overflow-y-auto gap-[10px]">
              ...
              <div className="flex h-[100%] w-full">
                ...
                {/* 📌 MOBILE → ONLY SHOW FOLDERS */}
                {isMobile && !showTaskScreen && (
                  <div className="w-full h-full">
                    <div className="w-full bg-white border-r h-[100%] border-slate-200 flex flex-col">
                      {/* Folders List */}
                      <div className="flex-1 overflow-y-auto p-2 h-[100%] space-y-2">
                        {folders.map((folder) => {
                          ...
                          return (
                            <div
                              key={folder.id}
                              className={`flex items-center relative justify-between w-full px-4 py-3 rounded-lg border transition-all group ${isActive
                            ...
                            >
                              <button
                                onClick={() => {
                                  ...
                                  if (isMobile) setShowTaskScreen(true);
                                }}
                          ...
                          <div className="max-w-4xl space-y-3">
                            {folderTasks.length === 0 ? (
                              ...
                              folderTasks.map((task, idx) => (
                                <div
                                  key={task.id}
                                  className={`bg-white border-2 rounded-xl p-4 hover:shadow-md transition-all group cursor-pointer ${task.isCompleted
                                ...
                                >
                                  <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <h3
                                        className={`text-lg font-semibold mb-1 ${task.isCompleted
                                      ...
                                      {task.description && (
                                        <p
                                          className={`text-sm mb-3 ${task.isCompleted
                                            ? "text-slate-400"
                                            : "text-slate-600"
                                            }`}
                                        >
                                    ...
                                    <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition">
                                      ...
                                      >
                                        <Star
                                          className={`w-5 h-5 ${task.isImportant
                ...
                {/* 📌 DESKTOP → SHOW BOTH SIDEBAR + TASKS */}
                {!isMobile && (
                  <>
